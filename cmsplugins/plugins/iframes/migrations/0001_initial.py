...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='IFrame',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='iframes_iframe', serialize=False, to='cms.CMSPlugin')),
                ...
                ('markup', models.TextField(max_length=700, verbose_name='iframe code')),
            ],
            options={
                'abstract': False,
            },
